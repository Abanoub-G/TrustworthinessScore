...
\title{A Trustworthiness Score to Evaluate CNNs Predictions}%A Measure of Trustworthiness to Evaluate CNNs Predictions}
\titlerunning{Trustworthiness Score to Evaluate CNNs Predictions}
\authorrunning{Ghobrial et al.}

\author{Abanoub Ghobrial\inst{1}, Darryl Hond\inst{2}, Hamid Asgari\inst{2}, Kerstin Eder\inst{1}}

\institute{Department of Computer Science, University of Bristol, Bristol, UK \and RTI Centre, Thales, Reading, UK}
...
is with Research, Technology and Innovation (RTI) centre,Thales, Reading, United Kingdom.}
